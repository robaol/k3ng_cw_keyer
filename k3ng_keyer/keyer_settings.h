...
#define initial_pot_wpm_low_value 5     // Potentiometer WPM fully CCW (13)
#define initial_pot_wpm_high_value 25    // Potentiometer WPM fully CW (35)
...
#define custom_startup_field "Robs Config (M5RAO)"   // an example could be callsign and name, eg. "AB1XYZ Bob", (or "Worlds best operator" which requires a 20 column display), string length shouldo be no more than the number of columns on the display
